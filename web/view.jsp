        ...
        <div class="container">
            <div class="row">
                    <table class="table table-striped" style="text-align: center; border: 1px solid #dddddd;">
                        <thead>
                            <tr>
                                <th colspan ="3" style="background-color: #eeeeee; text-align:center;">Bulletin Board</th>                           
                            </tr>
                        </thead>
                        <tbody>
                            <tr>
                    ...
                    <a href="bbs.jsp" class="btn btn-primary"> Board</a>
                    <%
                        if (userID != null && userID.equals(bbs.getUserID())){
                    %>
                        <a href="update.jsp?bbsID=<%= bbsID %>" class="btn btn-primary"> Revise </a>
                        <a onclick="return confirm('Are you sure you want to delete this?')" href="deleteAction.jsp?bbsID=<%= bbsID %>" class="btn btn-primary"> Delete </a>
                    <%  
                        }
                    %>
