...
<html>
    ...
    <body>
        <%
            ...
            int pageNumber = 1; // default page of board (page 1!!)
        ...
        <div class="container">
            <div class="row">
                ...
                <% 
                    if (pageNumber != 1){
                %>
                <a href ="bbs.jsp?pageNumber=<%=pageNumber - 1 %>" class ="btn btn-success btn btn-arrow-left">Previous</a>
                <%
                    }
                    if (bbsDAO.nextPage(pageNumber + 1)){ // if the next page is exist..
                %>
                 <a href ="bbs.jsp?pageNumber=<%=pageNumber + 1 %>" class ="btn btn-success btn btn-arrow-right">Next</a>
                <%
                    }
                %>
